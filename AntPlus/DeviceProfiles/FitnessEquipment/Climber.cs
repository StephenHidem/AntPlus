...
namespace SmallEarthTech.AntPlus.DeviceProfiles.FitnessEquipment
{
    ...
    public partial class Climber : FitnessEquipment
    {
        ...
        public Climber(ChannelId channelId, IAntChannel antChannel, ILogger logger, int timeout)
        ...
        /// <inheritdoc cref="Climber(ChannelId, IAntChannel, ILogger, int)"/>
        public Climber(ChannelId channelId, IAntChannel antChannel, ILogger logger, byte missedMessages)
