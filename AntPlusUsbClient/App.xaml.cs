...
namespace AntPlusUsbClient
{
    ...
    public partial class App : Application
    {
        ...
        public App()
        {
            ...
            AntRadio.GetChannel(0).AssignChannel(AntRadioInterface.ChannelType.BaseSlaveReceive, 0, 500);
            AntRadio.GetChannel(0).SetChannelID(0, false, 0, 0, 500);
            AntRadio.GetChannel(0).SetChannelFreq(57, 500);
            AntRadio.OpenRxScanMode();

            // create the device collection
            AntDevices = new AntDeviceCollection(AntRadio.GetChannel(0));
        }
    }
}
