...
namespace SmallEarthTech.AntPlus.DeviceProfiles.FitnessEquipment
{
    ...
    public partial class Rower : FitnessEquipment
    {
        ...
        public Rower(ChannelId channelId, IAntChannel antChannel, ILogger logger, int timeout)
        ...
        /// <inheritdoc cref="Rower(ChannelId, IAntChannel, ILogger, int)" />
        public Rower(ChannelId channelId, IAntChannel antChannel, ILogger logger, byte missedMessages)
