...
namespace SmallEarthTech.AntPlus.DeviceProfiles.BikeSpeedAndCadence
{
    ...
    public partial class CombinedSpeedAndCadenceSensor : AntDevice
    {
        ...
        public CombinedSpeedAndCadenceSensor(ChannelId channelId, IAntChannel antChannel, ILogger<CombinedSpeedAndCadenceSensor> logger, int? timeout = default, byte? missedMessages = default)
