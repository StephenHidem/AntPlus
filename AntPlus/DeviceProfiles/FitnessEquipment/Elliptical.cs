...
namespace SmallEarthTech.AntPlus.DeviceProfiles.FitnessEquipment
{
    ...
    public partial class Elliptical : FitnessEquipment
    {
        ...
        public Elliptical(ChannelId channelId, IAntChannel antChannel, ILogger logger, int timeout)
        ...
        /// <inheritdoc cref="Elliptical(ChannelId, IAntChannel, ILogger, int)"/>
        public Elliptical(ChannelId channelId, IAntChannel antChannel, ILogger logger, byte missedMessages)
